...
public enum MobEnum {
    ...
    ORC(0.15,10,10, Monde.MONDE_0, 210, 20, 40, false, 70, new CompetenceMob("Coup écrasant",60,0,0,0,0,0,0)),
    SERPENT(0.15,10,10, Monde.MONDE_1, 250, 35, 80, false, 280, new CompetenceMob("Mue",0,25,-5,0,0,0,0)),
    VAMPIRE(0.15,10,10, Monde.MONDE_1, 350, 35, 90, false, 300, new CompetenceMob("Saignée",30,0,0,0,0,0,70)),
    SLIME(0.15,10,10, Monde.MONDE_0, 100, 10, 30, false, 50, new CompetenceMob("Gélaine collante",0,0,0,10,0,0,0)),
    ...
    BIG_SLIME(0.15,10,10, Monde.MONDE_0, 380, 40, 50, true, 300, new CompetenceMob("Décharge d'acide",100,0,0,10,0,0,0)),
